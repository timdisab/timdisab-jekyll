...
- [ ] Transform class selector to BEM methodology.
...
- Since [`jekyll-postfiles`](https://github.com/nhoizey/jekyll-postfiles#compatibility) plugin isn't supported by github pages, this will cause your site problems, path broken or post images won't show up, you can host alternatively using [netlify.com](https://netlify.com), [vercel.com](https://vercel.com) or [surge.sh](https://surge.sh) services, which support 3rd party.
